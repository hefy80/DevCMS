...
//		$res = date('Y-m-d H:i:s','1397122429');
	...
	public function kpi(){
		header("Location: http://cms.wanbudev.com/index.php/Doc/index?path=L%2BWFtuS7li%2Fnu6nmlYjogIPmoLjmoIflh4YubWQ%3D"); 
		exit();
	}

	public function line2(){
		$story = D('Story');
		$res = $story->getLine2Stat();
